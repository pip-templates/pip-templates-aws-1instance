...
Build-EnvTemplate -InputPath "$($path)/../templates/cloud_install_platform_services_playbook.yml" -OutputPath "$($path)/../temp/cloud_install_platform_services_playbook.yml" -Params1 $config -Params2 $resources
ansible-playbook -i "$path/../temp/cloud_k8s_ansible_hosts" "$path/../temp/cloud_install_platform_services_playbook.yml"
